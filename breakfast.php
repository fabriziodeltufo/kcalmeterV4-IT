      ...
      <!-- =========================================== HEADER - MAIN MENU ============================================== -->
               ...
               <nav class="navbar navbar-expand-sm bg-dark navbar-dark justify-content-center">
                 <ul class="navbar-nav">
                   ...
                   <li class="nav-item">
                     <a class="nav-link active" href="breakfast.php">Colazione</a>
                   </li>
...
<!-- PAGE CONTENT - COLAZIONE -->

      <div>
          <h2 class="text-center tit">COLAZIONE</h2>
      ...
      <td>
        <div class="dropdown">
          ...
          <div class="dropdown-menu">
            ...
            <?php lista_alimenti('DD', 'breakfast.php') ; ?> <!-- DD = mostra lista alimento nel DROPDOWN -->
    ...
    <p><b>* Campi Richiesti.</b></p>
      ...
      <div class="container-fluid text-center">
        ...
        <div class="row d-flex justify-content-center">
                      ...
                      <div class="col-sm-2">
                        <div class="form-group">
                          <label for="categoria">FOOD CATEGORY</label>
                          <input REQUIRED value="<?php echo($_GET['categoria']);?>" type="text"  name="categoria" class="form-control">
                        </div>
                      </div>
