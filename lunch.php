      ...
      <!-- =========================================== HEADER - MAIN MENU ============================================== -->
               ...
               <nav class="navbar navbar-expand-sm bg-dark navbar-dark justify-content-center">
                 <ul class="navbar-nav">
                   ...
                   <li class="nav-item">
                     <a class="nav-link active" href="lunch.php">Pranzo</a>
                   </li>
...
<!-- PAGE CONTENT  - PRANZO -->
      ...
      <div>
          <h2 class="text-center tit">PRANZO</h2>
      ...
      <div class="text-center">
          <td>
            <div class="dropdown">
              ...
              <table class="text-center table table-striped table-hover table-condensed table-bordered table-sm">
                ...
                <?php lista_alimenti('DD', 'lunch.php') ; ?> <!-- DD = mostra lista alimento nel DROPDOWN -->
          ...
          <?php aggiungiAlimentoPasto("PRA"); ?>


          <hr>


          <!-- lista alimenti pasti con FORMper intercettare bottone CANCELLA (id_rec) -->
