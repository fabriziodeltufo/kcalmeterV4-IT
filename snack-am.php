      ...
      <!-- =========================================== HEADER - MAIN MENU ============================================== -->
               ...
               <nav class="navbar navbar-expand-sm bg-dark navbar-dark justify-content-center">
                 <ul class="navbar-nav">
                   ...
                   <li class="nav-item">
                     <a class="nav-link active" href="snack-am.php">Snack Mattina</a>
                   </li>
...
<!-- PAGE CONTENT - SNACK AM -->


      <div>
        <h2 class="text-center tit">PAUSA MATTINA</h2>
          ...
          <td>
            <div class="dropdown">
              ...
              <table class="text-center table table-striped table-hover table-condensed table-bordered table-sm">
                ...
                <?php lista_alimenti('DD', 'snack-am.php') ; ?> <!-- DD = mostra lista alimento nel DROPDOWN -->
